...
<template>
    <div class="container mx-auto">
        <div class="navbar bg-base-100">
            <div class="flex-1">
                <RouterLink :to="{name:'home'}" class="btn btn-ghost text-xl">Jarabe Shop</RouterLink>
            </div>
            <div class="flex-none gap-2">
                ...
                <button @click="login" v-if="!isLoggedIn" class="btn btn-ghost">Login</button> <!--Login หรือยัง-->
